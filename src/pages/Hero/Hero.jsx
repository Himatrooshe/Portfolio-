...
import { fadeIn, staggerElements } from "@/lib/animations";
...
const profile = {
  ...
  useEffect(() => {
    ...
    const titleAnimation = fadeIn(heroTitleRef.current, 0.2, 1.2);
    
    // If you have multiple elements to animate with stagger
    const contentElements = heroContentRef.current.querySelectorAll('.animate-item');
    if (contentElements.length > 0) {
      staggerElements(contentElements, 0.1, 0.5);
    }
        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* Name section with ref */}
              <div className="relative mb-6 sm:mb-8" ref={heroTitleRef}>
              ...
              {/* Role badge with ref */}
              <div ref={heroContentRef} className="animate-item inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-500/10 to-teal-500/10 border border-blue-500/20 mb-6 sm:mb-8 backdrop-blur-sm animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/mozahidulislamoshe"
